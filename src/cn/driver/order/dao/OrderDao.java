...
public class OrderDao {
	 ...
	 * @return
	 */
	public List<Order> deleteOid(String oid, String uid) {
		try {
			/*
			 * 先按oid删除orderitem，再删除orders，然后按uid查询所有
			 */
	...
	private void loadOrderItems(Order order) throws SQLException {
		 ...
		 */
		String sql = "select * from orderitem i, clothes c where i.cid=c.cid and oid=?";
		/*
		 ...
		 * count=2, subtotal=60.0, oid=1AE8A70354C947F8B81B80ADA6783155, cid=101,
		 * cname=领带,price=30.0,image=clothes_img/8991366-1_l.jpg, cid=101} ...
		 * 
		 * 我们需要使用一个Map生成两个对象：OrderItem、Tests，然后再建立两者的关系（把Clothes设置给OrderItem）
		 */
		/*
